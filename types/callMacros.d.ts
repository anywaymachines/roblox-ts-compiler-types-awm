...
declare function firstValue<T extends ReadonlyArray<T>>(object: T): T | undefined;
declare function firstValue<T extends ReadonlyMap<defined, T>>(object: T): T | undefined;
declare function firstValue<T extends ReadonlySet<T>>(object: T): boolean | undefined;
declare function firstValue<T extends object>(object: T): T[keyof T] | undefined;

declare function firstKey<T>(object: ReadonlyArray<T>): number | undefined;
declare function firstKey<T>(object: ReadonlyMap<T, defined>): T | undefined;
declare function firstKey<T>(object: ReadonlySet<T>): T | undefined;
declare function firstKey<T extends object>(object: T): keyof T | undefined;
